...
public interface AnswerDAO {
     ...
     *
     **/
    @Insert("INSERT INTO answer(surid, queid, content) VALUES(#{surid}, #{queid}, #{content})")
    void saveAnswer(@Param("surid")Integer surid, @Param("queid")Integer queid, @Param("content")String answer);
}
